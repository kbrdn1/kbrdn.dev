...
<template>
  <div class="space-y-3">
    ...
    <UiStaggerContainer :stagger-delay="50" :base-delay="0" class="flex flex-wrap gap-2">
      <UiStaggerItem
      ...
      >
        <UPopover mode="hover" :ui="{ content: 'p-0' }">
          <UButton
            :to="link.url"
            target="_blank"
            variant="soft"
          ...
          <template #content>
            <div class="w-72 p-3">
              ...
              <div class="flex items-center gap-3 mb-2">
                <div
                  class="flex items-center justify-center w-10 h-10 border border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-800"
                >
                  <UIcon
                    :name="link.icon || getIcon(link.platform)"
                ...
                <div>
                  ...
                  <p v-if="getHandle(link.platform)" class="text-xs font-mono text-neutral-500">
                    {{ getHandle(link.platform) }}
                  </p>
                </div>
              </div>
              ...
              <!-- Description -->
              <p
                v-if="getDescription(link.platform)"
                class="text-xs text-neutral-500 dark:text-neutral-400 mb-3"
              >
              ...
              >
                <div class="flex-1 text-center">
                  <p class="text-sm font-bold font-mono text-neutral-900 dark:text-neutral-100">
                    {{ githubProfile.followers }}
                  </p>
                  <p class="text-[9px] font-mono uppercase tracking-wider text-neutral-500">
                    followers
                  </p>
                </div>
