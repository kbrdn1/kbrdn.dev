...
<template>
  <div v-if="tracks?.length" class="mt-6">
    <span
      class="block text-[10px] font-mono uppercase tracking-widest text-neutral-400 dark:text-neutral-500 mb-3"
    >
      {{ t('music.listeningTo') }}
    </span>
    ...
    >
      ...
      >
        ...
        <div class="relative shrink-0 group/cover">
          ...
          <!-- Playing indicator -->
          <div v-if="isPlaying" class="absolute bottom-1 right-1 flex items-end gap-px h-3">
            <span
              class="w-0.5 bg-primary-500 rounded-full animate-[eq1_0.8s_ease-in-out_infinite]"
              style="height: 60%"
            />
            <span
              class="w-0.5 bg-primary-500 rounded-full animate-[eq2_0.8s_ease-in-out_infinite]"
              style="height: 100%"
            />
            <span
              class="w-0.5 bg-primary-500 rounded-full animate-[eq3_0.8s_ease-in-out_infinite]"
              style="height: 40%"
            />
          </div>
        </div>
                ...
                <button
                  ...
                  :class="
                    cn(
                      ...
                      shuffleMode ? 'text-primary-500' : 'text-neutral-400 hover:text-primary-500',
                    )
                  "
              ...
              <UTooltip :text="showListing ? t('music.hideList') : t('music.showList')">
                <button
                  ...
                  :class="
                    cn(
                      'flex items-center justify-center w-7 h-7 transition-colors cursor-pointer',
                      showListing ? 'text-primary-500' : 'text-neutral-400 hover:text-primary-500',
                    )
                  "
          ...
          <div class="flex items-center gap-2 mt-2">
            ...
            <div
              ...
              @keydown.right.prevent="
                audio && (audio.currentTime = Math.min(duration, audio.currentTime + 5))
              "
            >
              <div
                  ...
                  :class="
                    cn(
                      ...
                      isSeeking
                        ...
                        : 'scale-0 group-hover/bar:scale-100 opacity-0 group-hover/bar:opacity-100',
                    )
                  "
                />
              </div>
      ...
      <!-- Track indicators -->
      <div
        v-if="tracks.length > 1 && !showListing"
        class="flex items-center justify-center gap-2 px-3 pb-3"
      >
        <button
      ...
      <div
        ...
        :class="
          showListing
            ...
            : 'grid-rows-[0fr] opacity-0 border-t-transparent'
        "
        style="
          transition:
          ...
          <div class="max-h-48 overflow-y-auto">
            ...
            >
              <span
                :class="
                  cn(
                    'text-[10px] font-mono w-4 text-right shrink-0',
                    currentIndex === index ? 'text-primary-500' : 'text-neutral-400',
                  )
                "
              >
