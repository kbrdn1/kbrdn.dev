...
<template>
  <div class="h-full w-full flex relative overflow-hidden" style="background: #1a1a1a">
    ...
    <div
      ...
      style="top: 48px; bottom: 48px; left: 80px; right: 80px; padding: 32px 40px"
    >
      ...
      <div class="flex flex-col justify-center flex-1" style="padding: 16px 0">
        ...
        <p
          v-if="description"
          style="font-size: 18px; line-height: 1.5; color: #999999; max-width: 680px"
        >
          {{ description }}
        </p>
      </div>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center" style="gap: 8px">
          ...
          >
            <span style="color: #7dd3fc">blog</span><span style="color: #e0e0e0">@</span
            ><span style="color: #d4825d">kbrdn1</span>
          </span>
        </div>
      </div>
    </div>
