export default {
  ...
  seo: {
    ...
    ogDescription:
      "Développeur, Designer, Créateur. Je construis des choses pour le web.",
  },
  ...
  explore: {
    ...
    slides: {
      ...
      crafting: {
        ...
        description: "gwm — un gestionnaire de worktrees Git (CLI + TUI) construit en Rust. Je travaille aussi sur ce portfolio, des expériences d'architecture cloud, et j'approfondis Rust.",
      },
      blog: {
  ...
  footer: {
    ...
    contact: {
      title: "Me Contacter",
      description:
        "Un projet en tête ? Discutons de comment nous pouvons collaborer.",
      name: "Nom",
      ...
      error:
        "Échec de l'envoi. Veuillez réessayer ou m'envoyer un email directement.",
    },
    links: {
      title: "Me Suivre",
      other: "Liens",
